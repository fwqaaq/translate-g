...
A node lib about google translate api. <span style="color:red">It's done entirely using `ts`.And it has good type matching.</span>

## How to use

> First, download it, you may use `npm`、`yarn` or `pnpm`
